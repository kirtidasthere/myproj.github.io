const wondersdata = [ 
	...
	{
		id:16,
		image : "images/places/arizona.jpg",
		name : "Arizona",
		category : "places",
		description : "Arizona is famous for many things, including beautiful scenery and rich history. It's also known for its sun-drenched desert landscapes and cacti. Visitors to Arizona can experience all of these, as well as the state's more recent attractions like shopping centers, theme parks, and golf courses."
	},

	{
		id:17,
		image : "images/places/hawaii.jpg",
		name : "Hawaii",
		category : "places",
	...
	{
		id:18,
		image : "images/places/italy.jpg",
		name : "Italy",
		category : "places",
		description : "Italy is considered the most beautiful and romantic in the world. Rome’s city of Italy is perfect for holidaying with Partner. The beautiful artwork here will fascinate you. Called the capital of fashion, food, and cinema, Rome is quite famous by the people. People from all over the world like to come here. It considered the most vibrant city in Europe.  "
	},

	{
		id:19,
		image : "images/places/kenya.jpg",
		name : "Kenya",
		category : "places",
	...
	{
		id:20,
		image : "images/places/newzealand.jpg",
		name : "Newzealand",
		category : "places",
